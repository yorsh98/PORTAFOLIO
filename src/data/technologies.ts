...
export const technologies: Technology[] = [
  ['HTML5','html5','frontend'],['CSS3','css3','frontend'],['JavaScript','javascript','frontend'],['TypeScript','typescript','frontend'],['React','react','frontend'],['Vue.js','vuedotjs','frontend'],['Livewire','livewire','frontend'],['Tailwind CSS','tailwindcss','frontend'],['Vite','vite','frontend'],['Astro','astro','frontend'],['Bootstrap','bootstrap','frontend'],['Laravel','laravel','backend'],['PHP','php','backend'],['Python','python','backend'],['FastAPI','fastapi','backend'],['PostgreSQL','postgresql','data'],['MariaDB','mariadb','data'],['Redis','redis','data'],['Ollama','ollama','ai'],['LangChain','langchain','ai'],['LangGraph','langgraph','ai'],['Hugging Face','huggingface','ai'],['pgvector','pgvector','ai'],['MCP','modelcontextprotocol','ai'],['OpenCV','opencv','documents'],['Tesseract','tesseract','documents'],['FFmpeg','ffmpeg','audio'],['Docker','docker','infrastructure'],['Ubuntu','ubuntu','infrastructure'],['NVIDIA','nvidia','infrastructure'],['CUDA','cuda','infrastructure'],['Git','git','quality'],['GitHub','github','quality'],['VS Code','visualstudiocode','quality'],['Pytest','pytest','quality'],['ESLint','eslint','quality']
